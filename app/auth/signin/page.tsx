    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-800 text-center mb-8">Login Form</h2>
          
          <div className="flex mb-8">
            <button className="flex-1 py-2 px-4 text-center border-b-2 border-blue-500 text-blue-500 font-medium">
              Login
            </button>
            <Link href="/auth/signup" className="flex-1 py-2 px-4 text-center border-b-2 border-gray-300 text-gray-500 font-medium hover:text-gray-700">
              Signup
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? <AppLoader variant="button" label="Logging in" /> : 'Login'}
            </button>
          </form>
